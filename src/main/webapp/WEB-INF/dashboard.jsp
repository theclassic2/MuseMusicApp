...
<body>
	<div class="container">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-expand show text-end"
					...
					<div class="navbar-nav">
						<a class="nav-link active text-success" aria-current="page" href="/songs">Home</a>
		...
		<div class="bg-secondary">
			<h2 class="text-end display-4 mb-0 fst-italic px-5 py-3 text-success-emphasis ">Welcome ${currentUser.userName}</h2>
		</div>
		<div class="container min-vh-100 bg-secondary mt-0 ">
			<h2 class="display-4 text-center ">My Likes</h2>
			<div class="container d-flex justify-content-center">
				<table class="table table-hover w-75 table-light table-striped table-borderless">
					<thead>
						<tr>
